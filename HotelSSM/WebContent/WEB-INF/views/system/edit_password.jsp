        ...
        <table>
           <tr>
            ...
            <tr>
                ...
                <td><input type="password" id="oldPassword" class="wu-text easyui-validatebox" /></td>
            </tr>
            <tr>
                <td width="60" align="right">新密码:</td>
                <td><input type="password" id="newPassword" class="wu-text easyui-validatebox" /></td>
            </tr>
            <tr>
                <td width="60" align="right">重复新密码:</td>
                <td><input type="password" id="reNewPassword" class="wu-text easyui-validatebox"/></td>
            </tr>
        </table>
    </form>
</div>
