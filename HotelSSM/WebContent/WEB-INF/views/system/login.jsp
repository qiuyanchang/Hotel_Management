...
<div id="particles-js">
		<div class="login" style="background:url(../resources/admin/login/images/bg3.jpg) top left;
background-size:100%;">
			<div class="login-center clearfix">
				<div class="login-center-img"></div>
				<div class="login-center-input" style=" color:white;">
					用户名 <input type="text" name="username" id="username" value="" placeholder="请输入您的用户名" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请输入您的用户名&#39;">
			...
			<div class="login-center clearfix">
				<div class="login-center-img"></div>
				<div class="login-center-input" style=" color:white;">
					密码<input type="password" name="password" id="password" value=""   placeholder="请输入您的密码" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请输入您的密码&#39;">
					<!-- <div class="login-center-input-text">密码</div> -->
				</div>
			</div>
			<div class="login-button" style="background:#000; color:#FFF;">
				登录
			</div>
			<div class="login-button" style="background:#000; color:#FFF;">
			<a href="../home/index"><span style="color:white;">首页</span></a>
			</div>
		</div>
