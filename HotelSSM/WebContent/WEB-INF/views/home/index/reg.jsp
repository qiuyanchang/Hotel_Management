...
<body  style="background:url(../resources/admin/login/images/bg2.jpg) top center;
background-size:80%;">
  <!--头部-->
...
<script>
  ...
  $('#btn_reg').click(function(){
	  if(telLogin==0){
		  $("#uphone").nextElementSibling.innerHTML = '电话号码格式不正确';
		  $("#uphone").nextElementSibling.className = 'msg-error';
		  return;
	  }
    //表单序列化，获得所有的用户输入
    if (upwd2.value != upwd.value){
