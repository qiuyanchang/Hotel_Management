...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
     ...
     <%--       <label>所属楼层:</label>
            ...
            <a href="#" id="search-btn" class="layui-btn">搜索</a>
    ...
    <div class="layui-col-xs6">
        <button type="button" class="layui-btn" onclick="openAdd()">添加</button>
            <button type="button" class="layui-btn" onclick="openEdit()">修改</button>
              <button type="button" class="layui-btn" onclick="remove()">删除</button>
    </div>
    </div>
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td valign="middle">
                	<img id="preview-photo" style="float:left;"  width="100px">
		...
		$('#edit-dialog').dialog({
           ...
           /*      iconCls: 'icon-ok', */
            ...
            onBeforeOpen:function(){
            	...
            	$("#edit-floorId").combobox('setValue',-1);
