...
public class RoomController {
	...
	public Map<String, String> add(Room room){
		...
		Room r=roomService.findByIdAndName(room.getRoomTypeId(),room.getSn());
		
		if(r!=null) {
			ret.put("type", "error");
			ret.put("msg", "该类型下已经有这个房间！");
			return ret;
		}
		...
		//更改roomType的已入住数
//		if(room.getStatus()==1) {
//			roomTypeService.updateDiffNum(room.getStatus(),room.getRoomTypeId());
//		}
	...
	public Map<String, String> edit(Room room){
		...
		if(room.getFloorId() == null){
			/*
			 * ret.put("type", "error"); ret.put("msg", "请选择房间所属楼层!"); return ret;
			 */
			room.setFloorId((long) -1);
		}
